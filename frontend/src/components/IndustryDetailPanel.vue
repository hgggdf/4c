    ...
    <div class="content-scroll">
      ...
      <template v-if="activeTab === 'overview'">
        ...
        <div class="company-list">
          <div v-for="c in companies" :key="c.symbol" class="company-item company-item--clickable" @click="goToStock(c.symbol)">
            <div class="ci-left">
...
async function loadMacroData() {
  try {
    const items = await getMacroSummary(['CPI', 'PPI', 'GDP'], 1)
...
.company-item--clickable:hover {
  ...
  box-shadow: 0 2px 10px rgba(75,169,154,0.14);
