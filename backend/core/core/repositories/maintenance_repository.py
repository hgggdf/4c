...
from core.database.models.archive import (
...
from core.database.models.summary_cache import (
...
class MaintenanceRepository(BaseRepository):
    ...
    def archive_before(self, cutoff_date: date) -> dict[str, int]:
        from core.database.models.announcement_hot import CentralizedProcurementEventHot, RegulatoryRiskEventHot
        from core.database.models.news_hot import NewsCompanyMapHot, NewsIndustryMapHot
