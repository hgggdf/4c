...
class FinancialMetricHot(Base):
    ...
    __table_args__ = (
        UniqueConstraint("stock_code", "report_date", "metric_name", name="uk_financial_metric_hot"),
        Index("idx_fin_metric_hot_code_date", "stock_code", "report_date"),
    )
...
class FinancialNotesHot(Base):
    ...
    __table_args__ = (
        Index("idx_fin_note_hot_code_date", "stock_code", "report_date"),
        Index("idx_fin_note_hot_type", "note_type"),
    )
...
class BusinessSegmentHot(Base):
    ...
    __table_args__ = (
        ...
        Index("idx_segment_hot_name", "segment_name"),
    )
