...
@router.post("/delete-income-statements")
def batch_delete_income_statements(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_income_statements(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-balance-sheets")
def batch_delete_balance_sheets(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_balance_sheets(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-cashflow-statements")
def batch_delete_cashflow_statements(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_cashflow_statements(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-financial-metrics")
def batch_delete_financial_metrics(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_financial_metrics(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-financial-notes")
def batch_delete_financial_notes(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_financial_notes(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-business-segments")
def batch_delete_business_segments(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_business_segments(build_request(BatchUpsertFinancialRequest, payload)))
...
@router.post("/delete-stock-daily")
def batch_delete_stock_daily(payload: BatchUpsertFinancialModel, container: ServiceContainer = Depends(get_container)):
	return service_result_response(container.financial_write.batch_delete_stock_daily(build_request(BatchUpsertFinancialRequest, payload)))
