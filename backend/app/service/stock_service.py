...
from app.service.shared import build_quote_payload, ensure_demo_user, get_latest_trade_rows, normalize_percent, resolve_company, serialize_kline_row, to_float
...
class StockService:
    ...
    def _build_financial_abstract(self, db: Session, stock_code: str) -> list[dict]:
        ...
        by_year = latest_rows_by_year(all_rows, "fiscal_year")
